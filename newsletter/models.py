...
class Client(models.Model):
    email = models.EmailField(max_length=50, unique=True, verbose_name="Электронный адрес", help_text="Введите Ваш email")
    full_name = models.CharField(max_length=100, verbose_name="Ф.И.О.", help_text="Введите Ваше Ф.И.О.", blank=True,
                            null=True)
...
class Message(models.Model):
    theme = models.CharField(max_length=100, verbose_name="Тема письма", help_text="Введите тему Вашего письма",
                             blank=True,
                             null=True)
...
class AttemptMailing(models.Model):
    ...
    response = models.TextField(
        verbose_name="Ответ почтового сервера", help_text="Введите ответ почтового сервера", blank=True,
        null=True
    )
